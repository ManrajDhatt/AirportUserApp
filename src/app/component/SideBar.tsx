...
export default function Sidebar() {
  ...
  const fetchStoresForCategory = async (category: string) => {
    ...
    const storeList: Store[] = storeSnapshot.docs.map((doc) => {
      ...
      return {
        ...data,
        storeId: doc.id, // Ensure storeId is assigned correctly to Firestore document ID
      };
    });
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 bg-white text-black w-80 h-full shadow-lg p-6 flex flex-col z-40 overflow-y-auto sidebar-container"
          >
