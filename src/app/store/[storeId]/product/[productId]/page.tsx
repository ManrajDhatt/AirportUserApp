...
// Define Product interface to match StoreContext and Cards
interface Product {
  id: string;
  price: string;
  productImageUrl?: string;
...
export default function ProductPage() {
  ...
  const handleCartToggle = () => {
    ...
    if (isInCart) {
      ...
      setCartItems((prev) => [...prev, newItem]);
      addToCart(newItem, storeId, newItem.quantity);
  ...
  return (
    <div className="bg-gray-50 text-gray-900 min-h-screen">
      ...
      <div className="py-4 px-4 md:px-8 lg:px-20 flex items-center gap-2 text-gray-500 text-sm bg-white shadow-sm">
        ...
        <p className="hover:text-blue-600 cursor-pointer">{product.catalogueCategoryName || "Category"}</p>{" "}
        <ArrowRight size={14} />
                ...
                <div className="flex items-baseline gap-3">
                  {hasDiscount ? (
                    <>
                      ...
                      <p className="text-sm font-semibold bg-green-100 text-green-800 px-2 py-1 rounded">
